...
class StaffController extends Controller
{
    ...
    public function createOrderWalks(Request $req){
        ...
        return redirect('/staff/setOrderDateTime/'.serialize($arr));
    }

    public function createOrderMotors(Request $req){
        $arr = array_merge($req->all());
        return redirect('/staff/setOrderDateTimeMotor/'.serialize($arr));
    }

    public function createOrderCars(Request $req){
        $arr = array_merge($req->all());
        return redirect('/staff/setOrderDateTimeCar/'.serialize($arr));
    }
...
//            dump("key = ".$key." data = ".$data);
        ...
        if($ofl != null){
            ...
            return view('staff.deliveryLater',
                compact('pickUpLocation',
                    'latitudePickup',
                    'longitudePickup',
                    'dropOffLocation',
...
//            dump('$Key => ' . $key . ' $data => ' . $data);
        ...
        return redirect('staff/showOrderDetails/'.$getLatestOrderID->order_id);
    }
    ...
    public function showActiveOrder(){
        ...
        return view('staff.activeOrder', compact('activeOrder'));
    }
...
//            dump($runnerTelephone);
        ...
        return view('staff.orderDetail', compact('OrderDetails', 'OrderServiceDetails', 'isRunnerAlreadyFavourite', 'runnerTelephone'));
    }
    ...
    public function showOrderRecords(){
        ...
        return view('staff.pastOrder', compact('AllOrder','CompleteOrder','CancelledOrder','WalkOrder','MotorOrder','CarOrder'));
    }
...
//            dump($runnerTelephone);
        ...
        return view('staff.pastOrderDetail', compact('pastOrderDetails', 'OrderServiceDetails', 'isRunnerAlreadyFavourite', 'runnerTelephone'));
...
//            dump('runner id => '.$item->runner_id);
        ...
        return view('staff.favouriteRunner', compact('runnerArray', 'i', 'favOrderCount'));
    }
...
//        dump($runnerDetails);
        ...
        return view('staff.favouriteRunnerDetail', compact('runnerDetails'));

    }

    public function addIcStaff(Request $req){
...
//        $path2 = $files2->move($destinationPath,$name2);
    ...
    public function addImageStaff(Request $req){
