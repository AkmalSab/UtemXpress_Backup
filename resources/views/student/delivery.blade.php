...
<html lang="en">
    ...
    <x-header-component/>
        <div class="container mt-3" id="contactDetails">
            <form method="POST" action="{{url('/student/submitOrder')}}">
                @csrf
                <h3 class="text-center">Delivery Date & Contact Information</h3>
                <div class="row mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    @foreach($users as $item)
                        <input type="text" class="form-control" id="senderName" name="senderName" value="{{$item->student_name}}">
                    @endforeach
                </div>
                <div class="form-group mb-3">
