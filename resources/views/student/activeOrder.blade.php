            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                @if($activeOrder->isEmpty())
                    <div class="container justify-content-center text-center">
                        ...
                        <a href="{{url('/student/home/')}}" class="btn btn-primary">Back to Home</a>
                    </div>
                @else
                        ...
                        <div class="col">
                            <div class="list-group">
                                @if($item->order_type == "on-demand")
                                    <a href="{{url('/student/showOrderDetails/'.$item->order_id)}}" class="list-group-item list-group-item-action mt-3" aria-current="true" style="background-color: #0004f5; color: white;">
                ...
                @foreach($activeOrder as $item)
                    <div class="col">
                        <div class="list-group">
                            ...
                            <a href="{{url('/student/showOrderDetails/'.$item->order_id)}}" class="list-group-item list-group-item-action mt-3" aria-current="true" style="background-color: yellow;">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1">#{{$item->order_id}}</h5>
                                    <small>
                                        {{date('d/m/y', strtotime($item->order_date))}} -
