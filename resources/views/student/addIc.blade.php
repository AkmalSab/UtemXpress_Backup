    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add IC Image</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div id="modal-error"></div>
                <form method="POST" action="{{url('/student/insertIcImage')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{url('/student/insertImage')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
