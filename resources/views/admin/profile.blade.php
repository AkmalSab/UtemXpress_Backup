        ...
        <div class="container justify-content-center">
            <div class="card align-content-center ">
                <div class="card-body">
                    ...
                    @endif
                    <h2 class="card-title"><i class="cil-user"></i>Profile</h2>
                    <h6 class="card-subtitle mb-2 text-muted">Admin's personal information</h6>
                    <table class="table">
                        <tbody>
                        <tr>
...
<script>
    var element = document.getElementsByClassName("nav-link adminprofile	");
